...
if __name__ == "__main__":
    ...
    schedule.every().monday.at("09:00").do(scheduled_absence)
    schedule.every().monday.at("14:00").do(scheduled_absence)
    schedule.every().tuesday.at("09:00").do(scheduled_absence)
    schedule.every().tuesday.at("14:00").do(scheduled_absence)
    schedule.every().wednesday.at("09:00").do(scheduled_absence)
    schedule.every().thursday.at("10:00").do(scheduled_absence)
    schedule.every().thursday.at("14:00").do(scheduled_absence)
    schedule.every().friday.at("09:00").do(scheduled_absence)
    schedule.every().friday.at("14:00").do(scheduled_absence)
    schedule.every().saturday.at("08:00").do(scheduled_absence)
    schedule.every().saturday.at("14:00").do(scheduled_absence)
